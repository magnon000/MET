...
ping_file = 'ping_quantic_direct_tv_ipv4.txt'  # change txt file name here for different Internet connections
route_file = 'tracert_quantic_direct_tv_ipv4.txt'
